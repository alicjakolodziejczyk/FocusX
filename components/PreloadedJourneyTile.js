...
const JourneyTile = props => {
  ...
  return (
    <View style={styles.box}> 
         ...
         <TouchableOpacity
          onPress={() => navigation.navigate('PreloadedList', {journeyInfo: props})}
          style={styles.button}
        >
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('PreloadedSummary', {journeyInfo: props})}
          style={styles.button}
        >
          <View style={[styles.buttonContainer, styles.buttonContainerOutline]}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('PreloadedChat', {journeyInfo: props})}
          style={styles.button}
        >
          <View style={[styles.buttonContainer, styles.buttonContainerOutline]}>
